  ...
  methods: {
    filterZone (e) {
      if (e.target.value === " ") {
        ...
        // this.travelData.length = 0;
        // this.travelData = this.allTravelData.filter((item, i, array) => {
        //   return item.Zone == e.target.value;
        // });
        // this.$bus.$emit('updated', this.travelData);
    ...
    travelFilter () {
      ...
      // const Len = this.checkBox.length;
      // for (let j = 0; j < Len; j++) {
      //   switch (j) {
      //     case 0:
      //       if (this.checkBox[0] == false) {
      //         this.$bus.$emit('updated', this.travelData);
      //       } else {
      //         this.filterData = this.travelData.filter((item, i, array) => {
      //           return item['Ticketinfo'] == this.categories[1] && item['Opentime'] == this.categories[2] && ' ';
      //         });
      //         this.$bus.$emit('updated', this.filterData);
      //       }
      //       break;
      //     case 1:
      //       if (this.checkBox[0] == false && this.checkBox[1] == true) {
      //         this.travelData.length = 0;
      //         this.travelData = this.filterData.filter((item, i, array) => {
      //           return item['Ticketinfo'] == this.categories[1];
      //         });
      ...
      //       break;
      //      case 2:
      //       if (this.checkBox[0] == false && this.checkBox[2] == true) {
